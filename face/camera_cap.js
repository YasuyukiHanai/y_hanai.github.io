  ...
  function ready() {
    document.getElementById("capture").onclick = function() {
          var scene = document.querySelector('#jeeFaceFilterCanvas');
          var video = scene;

          if (scene && video) {
            console.log(video.width)
            if (window.devicePixelRatio) {
                width = video.clientWidth * devicePixelRatio;
                height = video.clientHeight * devicePixelRatio;
                // width = video.width * devicePixelRatio;
                // height = video.height * devicePixelRatio;
